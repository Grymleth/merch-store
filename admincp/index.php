...
define('__BASE_URL__', SERVER_PROTOCOL.HTTP_HOST.__RELATIVE_ROOT__."admincp/");


$arrAdminSideBar = array(
    array( array(INVENTORY_USER, FINANCIAL_USER, ADMIN_USER), "Profile", "fa-users",
        array(
            array( array(INVENTORY_USER, FINANCIAL_USER, ADMIN_USER), "account/info", "Account Info"),
            array( array(ADMIN_USER), "account/register", "Register Account"),
            array( array(ADMIN_USER), "account/search", "Search Account"),
        ),
    ),
);
            ...
            <?php
                ...
                foreach($arrAdminSideBar as $adminSidebar){
                    ...
                    <li class=\"nav-item\">
                        ...
                        <div id=\"collapse". $adminSidebar[1] ."\" class=\"collapse\" aria-labelledby=\"heading". $adminSidebar[1] ."\" data-parent=\"#accordionSidebar\">
                        <div class=\"bg-white py-2 collapse-inner rounded\">";
                            foreach($adminSidebar[3] as $sideBarItem){
                                echo
                                "
                            <a class=\"collapse-item\" href=\"".  __BASE_URL__ . $sideBarItem[1] ."\">". $sideBarItem[2] ."</a>
                                ";
                            }                        
                    echo   
                        "</div>
